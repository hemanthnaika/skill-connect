...
const Hero = () => {
  return (
    <section className=" bg-primary/5 pt-12">
      <CustomLayout>
        <div className="flex flex-col-reverse gap-10 md:flex-row py-12">
          <div className="flex-1">
            <h5 className="text-3xl md:text-5xl/[60px] font-semibold w-full bg-linear-to-r from-slate-900 to-[#6D8FE4] text-transparent bg-clip-text ">
              Share Your Skills.
              <br /> Learn Something New.
            </h5>

            <p className="text-sm md:text-base max-w-lg mt-6 max-md:px-2 text-slate-600">
              SkillConnect is a community platform where anyone can teach,
              learn, or join workshops — online or offline. Attend live classes,
              grow your skills, and connect with people who share your
              interests.
            </p>
