  ...
  return (
    <section className="flex flex-col gap-5">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4   gap-5">
        <CardSection title="Total Users" total={totalUsers} icon={Users} />
        <CardSection
          title="Total Workshops"
          total={totalWorkshops}
          icon={Book}
        />
        <CardSection title="Pending KYC" total={pendingKyc} icon={Verified} />
        <CardSection title="Revenue" total={totalRevenue} icon={Banknote} />
      </div>
